 ...
 */
class Cradle_Storm_Sqlite_QueryAlter_Test extends TestCase
{
  /**
   * @var QueryAlter
   */
  ...
  /**
   * @covers Cradle\Storm\Query\Sqlite\QueryAlter::__construct
   */
  ...
  /**
   * @covers Cradle\Storm\Query\Sqlite\QueryAlter::addField
   */
  public function testAddField()
  {
    $instance = $this->object->addField('foobar', array());
		$this->assertInstanceOf('Cradle\Storm\Query\Sqlite\QueryAlter', $instance);
  }

  /**
   * @covers Cradle\Storm\Query\Sqlite\QueryAlter::addForeignKey
   */
  ...
  /**
   * @covers Cradle\Storm\Query\Sqlite\QueryAlter::addUniqueKey
   */
  ...
  /**
   * @covers Cradle\Storm\Query\Sqlite\QueryAlter::changeField
   */
  ...
  /**
   * @covers Cradle\Storm\Query\Sqlite\QueryAlter::getQuery
   */
...
ADD UNIQUE ("foobar");', $actual);
  ...
  /**
   * @covers Cradle\Storm\Query\Sqlite\QueryAlter::removeField
  ...
  /**
   * @covers Cradle\Storm\Query\Sqlite\QueryAlter::removeForeignKey
   */
  ...
  /**
   * @covers Cradle\Storm\Query\Sqlite\QueryAlter::removeUniqueKey
   */
  ...
  /**
   * @covers Cradle\Storm\Query\Sqlite\QueryAlter::setName
   */
