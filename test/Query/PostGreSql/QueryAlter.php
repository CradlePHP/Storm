 ...
 */
class Cradle_Storm_PostGreSql_QueryAlter_Test extends TestCase
{
  /**
   * @var QueryAlter
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryAlter::__construct
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryAlter::addField
   */
  public function testAddField()
  {
    $instance = $this->object->addField('foobar', array());
		$this->assertInstanceOf('Cradle\Storm\Query\PostGreSql\QueryAlter', $instance);
  }

  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryAlter::addPrimaryKey
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryAlter::changeField
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryAlter::getQuery
   */
...
ADD PRIMARY KEY ("foobar");', $actual);
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryAlter::removeField
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryAlter::removePrimaryKey
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryAlter::setName
   */
