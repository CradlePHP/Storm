...
class Cradle_Storm_PostGreSql_QueryUpdate_Test extends TestCase
{
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryUpdate::getQuery
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryUpdate::set
   */
  public function testSet()
  {
    $instance = $this->object->set('foo', 'bar');
		$this->assertInstanceOf('Cradle\Storm\Query\PostGreSql\QueryUpdate', $instance);
  }
}
