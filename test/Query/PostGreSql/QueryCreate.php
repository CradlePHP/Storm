 ...
 */
class Cradle_Storm_PostGreSql_QueryCreate_Test extends TestCase
{
  /**
   * @var QueryCreate
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryCreate::addField
   */
  public function testAddField()
  {
    $instance = $this->object->addField('foobar', array());
		$this->assertInstanceOf('Cradle\Storm\Query\PostGreSql\QueryCreate', $instance);
  }

  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryCreate::addPrimaryKey
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryCreate::getQuery
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryCreate::setFields
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryCreate::setName
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryCreate::setPrimaryKeys
   */
  ...
  /**
   * @covers Cradle\Storm\Query\PostGreSql\QueryCreate::withOids
   */
