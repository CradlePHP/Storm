 ...
 */
class Cradle_Storm_Engine_MySql_QueryCreate_Test extends TestCase
{
  /**
   * @var QueryCreate
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::__construct
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::addField
   */
  public function testAddField()
  {
    $instance = $this->object->addField('foobar', array());
		$this->assertInstanceOf('Cradle\Storm\Query\MySql\QueryCreate', $instance);
  }

  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::addKey
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::addPrimaryKey
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::addUniqueKey
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::getQuery
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::setComments
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::setFields
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::setKeys
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::setName
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::setPrimaryKeys
   */
  ...
  /**
   * @covers Cradle\Storm\Query\MySql\QueryCreate::setUniqueKeys
   */
